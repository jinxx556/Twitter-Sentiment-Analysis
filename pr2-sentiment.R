...
load("C:/Users/liz/Desktop/tweets.Rdata")
...
#aapldate=lapply(tweets,function(t) t$getCreated())
...
#score.index=lapply(c(1:12354),function(i) if(positive.score[[i]]>=negative.score[[i]]){1}else{0})
#aapl.sd=as.data.frame(cbind(score.index,aapldate))

#aapl.sd%>% separate(aapldate, into=c("day","time"),sep=)
...
ggplot(dpwords,aes(pwords,Freq))+geom_bar(stat="identity",fill="lightblue")+theme_bw()+
  ...
  geom_text(aes(1,5,label=paste("Total Positive Words : 8154")),size=4,hjust=0)+theme(axis.text.x=element_text(angle=45))+theme(text = element_text(size = 25))
...
ggplot(dnwords,aes(nwords,Freq))+geom_bar(stat="identity",fill="lightblue")+theme_bw()+
  ...
  geom_text(aes(1,5,label=paste("Total Negative Words : 7708")),size=4,hjust=0)+theme(axis.text.x=element_text(angle=45))+theme(text = element_text(size = 25))

##fb##
ggplot(dpwords,aes(pwords,Freq))+geom_bar(stat="identity",fill="lightblue")+theme_bw()+
  geom_text(aes(pwords,Freq,label=Freq),size=4)+
  labs(x="Major Positive Words", y="Frequency of Occurence",title=paste("Major Positive Words and Occurence in \n '","FACEBOOK","' twitter feeds, n =13557"))+
  geom_text(aes(1,5,label=paste("Total Positive Words : 4200")),size=4,hjust=0)+theme(axis.text.x=element_text(angle=45))+theme(text = element_text(size = 25))

ggplot(dnwords,aes(nwords,Freq))+geom_bar(stat="identity",fill="lightblue")+theme_bw()+
  geom_text(aes(nwords,Freq,label=Freq),size=4)+
  labs(x="Major Negative Words", y="Frequency of Occurence",title=paste("Major Negative Words and Occurence in \n '","FACEBOOK","' twitter feeds, n =13557"))+
  geom_text(aes(1,5,label=paste("Total Negative Words : 3805")),size=4,hjust=0)+theme(axis.text.x=element_text(angle=45))+theme(text = element_text(size = 25))
...
ggplot(dpwords,aes(pwords,Freq))+geom_bar(stat="identity",fill="lightblue")+theme_bw()+
  ...
  geom_text(aes(1,5,label=paste("Total Positive Words : 5823")),size=4,hjust=0)+theme(axis.text.x=element_text(angle=45))+theme(text = element_text(size = 25))

ggplot(dnwords,aes(nwords,Freq))+geom_bar(stat="identity",fill="lightblue")+theme_bw()+
  geom_text(aes(nwords,Freq,label=Freq),size=4)+
  labs(x="Major Negative Words", y="Frequency of Occurence",title=paste("Major Negative Words and Occurence in \n '","APPLE","' twitter feeds, n =12354"))+
  geom_text(aes(1,5,label=paste("Total Negative Words : 3238")),size=4,hjust=0)+theme(axis.text.x=element_text(angle=45))+theme(text = element_text(size = 25))
...
wfh=wf%>%
  filter(freq>=75,!word==tolower("APPL"))
